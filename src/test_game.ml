...
let locations = [{id = Square 1; left = Null; right = Square 2};
				 ...
				 {id = Square 4; left = Null; right = Null}]

let action1 = {actionType = ChoiceCol;
